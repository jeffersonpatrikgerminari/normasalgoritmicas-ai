...
const content = {
  pt: {
    ...
    problem: {
      ...
      text:
        "A dogmática jurídica tradicional não explica, com precisão suficiente, como infraestruturas técnicas, fluxos digitais e automações condicionam a atuação institucional e reconfiguram o funcionamento do sistema de justiça.",
      cards: [
        {
